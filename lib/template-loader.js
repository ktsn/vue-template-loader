...
module.exports = function (content) {
  ...
  const { style: stylePath, scoped: scoped } = parseQuery(this.request.split('?').pop())
  ...
  let output = writeRenderCode(compiled.code, id, stylePath, scoped === undefined ? options.scoped : yn(scoped), shouldHotReload)
  if (shouldHotReload) {
